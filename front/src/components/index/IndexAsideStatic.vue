	...
	<el-aside class="index-aside" width="200px">
		<div class="index-aside-inner menulist">
			<div v-for="item in menuList" :key="item.roleName" v-if="role == item.roleName" class="menulist-item">
				...
				<el-menu :mode="2 == 1 ? 'horizontal' : 'vertical'" :unique-opened="true" class="el-menu-demo"
					default-active="0">
					<el-menu-item index="0" @click="menuHandler('')"><i v-if="true"
							class="el-icon-menu el-icon-s-home" />首页</el-menu-item>
					<el-submenu :index="1 + ''">
						<template slot="title">
		...
		& /deep/ .el-menu.el-menu--inline {
			...
			.el-menu-item {
				...
				&.is-active {
					...
					border-style: solid;
					border-color: rgba(0, 0, 0, 0);
					background-color: rgb(236, 158, 103) !important;
...
.el-menu--horizontal .el-menu--popup .el-menu-item:hover {
	...
	border-style: solid;
	border-color: rgba(0, 0, 0, 0);
	background-color: rgba(127, 131, 221, 1) !important;
	box-shadow: 0 0 6px rgba(30, 144, 255, 0);
	text-align: left;
}
</style>
