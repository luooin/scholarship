<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="奖项名称" prop="jiangxiangmingcheng">
          <el-input v-model="ruleForm.jiangxiangmingcheng" 
              placeholder="奖项名称" clearable  :readonly="ro.jiangxiangmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="奖项名称" prop="jiangxiangmingcheng">
              <el-input v-model="ruleForm.jiangxiangmingcheng" 
                placeholder="奖项名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学习成绩" prop="xuexichengji">
          <el-input v-model="ruleForm.xuexichengji" 
              placeholder="学习成绩" clearable  :readonly="ro.xuexichengji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="学习成绩" prop="xuexichengji">
              <el-input v-model="ruleForm.xuexichengji" 
                placeholder="学习成绩" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="思德成绩" prop="sidechengji">
          <el-input v-model="ruleForm.sidechengji" 
              placeholder="思德成绩" clearable  :readonly="ro.sidechengji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="思德成绩" prop="sidechengji">
              <el-input v-model="ruleForm.sidechengji" 
                placeholder="思德成绩" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="评分结果" prop="pingfenjieguo">
            <el-input v-model="pingfenjieguo"
                placeholder="评分结果" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.pingfenjieguo" label="评分结果" prop="pingfenjieguo">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shenqingshijian = true;
          ...
          if(o=='xuexichengji'){
            this.ruleForm.xuexichengji = obj[o];
	    this.ro.xuexichengji = true;
            continue;
          }
          if(o=='sidechengji'){
            this.ruleForm.sidechengji = obj[o];
	    this.ro.sidechengji = true;
            continue;
          }
          if(o=='pingfenjieguo'){
    ...
    info(id) {
      this.$http({
        url: `pingjiangpingyoujieguo/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
	...
	this.ruleForm.shenqingneirong = this.ruleForm.shenqingneirong.replace(reg,'../../../scholarship/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    // 提交
    onSubmit() {
        this.ruleForm.pingfenjieguo = this.pingfenjieguo
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `pingjiangpingyoujieguo/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.pingjiangpingyoujieguoCrossAddOrUpdateFlag = false;
						 this.parent.search();
