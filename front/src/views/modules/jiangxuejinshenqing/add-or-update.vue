<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="奖项名称" prop="jiangxiangmingcheng">
          <el-select :disabled="ro.jiangxiangmingcheng" v-model="ruleForm.jiangxiangmingcheng" placeholder="请选择奖项名称">
            <el-option
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.shenqingcailiao" label="申请材料" prop="shenqingcailiao">
          <file-upload
          tip="点击上传申请材料"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.shenqingcailiao" label="申请材料" prop="shenqingcailiao">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.shenqingcailiao)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
