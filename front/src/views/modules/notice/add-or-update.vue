<template>
  <div class="addEdit-block">
    <el-form class="detail-form-content" ref="ruleForm" :model="ruleForm" :rules="rules" label-width="80px"
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="公告标题" prop="name">
            <el-input v-model="ruleForm.name" placeholder="公告标题" clearable :readonly="ro.name"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="公告标题" prop="name">
              <el-input v-model="ruleForm.name" placeholder="公告标题" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="公告内容" prop="content">
            <el-input type="textarea" v-model="ruleForm.content" placeholder="公告内容" clearable
              :readonly="ro.mima"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="公告内容" prop="mima">
              <el-input type="textarea" v-model="ruleForm.content" placeholder="公告内容" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
      </el-row>
            ...
            this.$http({
              ...
              if (data && data.code === 0) {
                if (data.data.total >= crossoptnum) {
                  ...
                  this.$http({
                    url: `notice/${!this.ruleForm.id ? "save" : "update"}`,
                    method: "post",
                    data: this.ruleForm
                  }).then(({ data }) => {
                    if (data && data.code === 0) {
                      this.$message({
                        ...
                        onClose: () => {
                          ...
                          this.parent.noticeCrossAddOrUpdateFlag = false;
                          this.parent.search();
